...
def get_distance(frame):
    ...
    #The depth scale of D435i is 0.0010000000474974513 .
    distance = float(frame[y_center][x_center])* 0.0010000000474974513 * 100
...
def main():
    ...
    rospy.init_node("IntelCamera_Distance_Node", anonymous=True)
